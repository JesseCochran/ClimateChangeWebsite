...
public class PageST2C implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        // if (StartYear_drop != null && !StartYear_drop.isEmpty()
        // && years.get(i).getYear() >= Integer.parseInt(StartYear_drop)) {
        // html = html + "<option>" + years.get(i).getYear() + "</option>";
        // }
        // }
        for (Climate year : years) {
            html = html + "<option>" + year.getYear() + "</option>";
        ...
        // html = html + " <div class='form-group'>";
        // html = html + "<p></p>";
        // html = html + " <label for='EndYear_drop'>Select the end year
        // (Dropdown):</label>";
